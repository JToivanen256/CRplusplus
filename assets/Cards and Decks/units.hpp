...
UnitCard HogRider("Hog Rider", 3, 1500, 300, true, 1.0f, 30.0f, 10.0f, 100.0f);
UnitCard BigRider("Big Rider", 4, 2000, 400, false, 1.5f, 30.0f, 10.0f, 100.0f);
UnitCard MiniRider("Mini Rider", 2, 1000, 200, true, 0.5f, 60.0f, 10.0f,
                   100.0f);
UnitCard FatRider("Fat Rider", 5, 2500, 500, false, 2.0f, 30.0f, 70.0f,
                  100.0f);  // "ranged" unit
